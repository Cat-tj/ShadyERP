...
- [x] **C8** — Sambungkan `WholesalePrice` (bug: model ada di schema, tidak pernah dipakai di checkout) + harga beda per channel (dine-in/takeaway/dll pakai `OrderType` yang sudah ada) — `0bc2fbb`
