...
export default async function JurnalPage() {
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      <div>
        <h1 className="font-display text-2xl font-semibold text-[var(--color-text)]">Jurnal Umum & Buku Besar</h1>
        <p className="text-sm text-[var(--color-text-secondary)]">
          Audit transparansi transaksi pembukuan otomatis (double-entry ledger) untuk seluruh aktivitas kasir POS, pengeluaran operasional, dan hutang supplier Anda.
        </p>
      </div>
