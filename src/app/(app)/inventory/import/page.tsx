...
export default function InventoryImportPage() {
  ...
  function parseCSV(text: string): ParsedRow[] {
    ...
    for (let i = 1; i < lines.length; i++) {
      const line = lines[i];
      // Basic CSV cell extraction (handles simple quotes, doesn't require massive parser)
  ...
  function downloadTemplate() {
    const headers = "Name,SKU,Category,Price,Cost,TrackStock,StockQty,ReorderPoint,Kind\n";
    const sampleRow = "Kopi Susu Gula Aren,KOPI-01,Kopi,18000,8000,true,50,5,GOODS\nKopi Hitam Toraja,KOPI-02,Kopi,15000,6000,true,30,5,GOODS\nJasa Cuci Motor,,Jasa,25000,,false,,,SERVICE\nPaper Bag,,Kemasan,2000,1000,false,,,NON_INVENTORY\n";
              ...
              <div className="rounded-lg border-2 border-dashed border-[var(--color-border)] p-6 text-center hover:bg-[var(--color-bg)] transition-colors">
                ...
                <label htmlFor="csv-file-input" className="cursor-pointer">
                  ...
                  <span className="mt-1 block text-xs text-[var(--color-text-secondary)]">
                    Maksimum ukuran file 5MB · Format .csv saja
                  </span>
                </label>
              </div>
