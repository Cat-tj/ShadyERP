...
import { WalletIcon, ReceiptIcon, BarChartIcon, TrendingUpIcon } from "@/components/ui/icons";
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        ...
        <StatTile label="Estimasi untung" value={formatRupiah(summary.estimasiUntung)} icon={TrendingUpIcon} />
      </div>
