  ...
  return (
    <div className="w-full max-w-sm rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
      <div className="mb-5 text-center">
        <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--color-primary)] text-xl font-bold text-white">
          {tenantName.slice(0, 1).toUpperCase()}
        </div>
        <h1 className="text-xl font-bold text-[var(--color-text)]">Daftar member {tenantName}</h1>
