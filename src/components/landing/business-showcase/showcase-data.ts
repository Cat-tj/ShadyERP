...
const phones = { cafe: CafePhone, toko: TokoPhone, supermarket: SupermarketPhone, laundry: LaundryPhone, counter: CounterPhone, jasa: JasaPhone, pabrik: PabrikPhone, company: CompanyPhone, teams: TeamsPhone, accounting: AccountingPhone } satisfies Record<VerticalKey, ShowcaseDefinition["Phone"]>;
const laptops = { cafe: CafeLaptop, toko: TokoLaptop, supermarket: SupermarketLaptop, laundry: LaundryLaptop, counter: CounterLaptop, jasa: JasaLaptop, pabrik: PabrikLaptop, company: CompanyLaptop, teams: TeamsLaptop, accounting: AccountingLaptop } satisfies Record<VerticalKey, ShowcaseDefinition["Laptop"]>;
const tablets = { cafe: CafeTablet, toko: TokoTablet, supermarket: SupermarketTablet, laundry: LaundryTablet, counter: CounterTablet, jasa: JasaTablet, pabrik: PabrikTablet, company: CompanyTablet, teams: TeamsTablet, accounting: AccountingTablet } satisfies Record<VerticalKey, ShowcaseDefinition["Tablet"]>;
